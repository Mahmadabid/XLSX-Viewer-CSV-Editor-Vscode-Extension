...
export class TSVEditorProvider implements vscode.CustomReadonlyEditorProvider {
    ...
    private getWebviewContent(webviewPanel: vscode.WebviewPanel): string {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.context.extensionUri, 'resources', 'table', 'tableWebview.js'));
        ...
        <body>
            ...
            <div class="toolbar">
                ...
                <button id="toggleTableEditButton" class="toggle-button" title="Edit TSV directly in the table">
                    Edit Table
                </button>
                ...
                <button id="openSettingsButton" class="toggle-button icon-only" title="TSV Settings">
                ...
                <button id="toggleBackgroundButton" class="toggle-button" title="Toggle Theme (Light / Dark / VS Code)">
                    ...
                    <svg id="vscodeIcon" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path fill="currentColor" d="M4 6c-1.105 0-2 .895-2 2v12c0 1.1.9 2 2 2h12c1.105 0 2-.895 2-2H4V6zm16-4H8c-1.105 0-2 .895-2 2v12c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V4c0-1.105-.895-2-2-2zm-5 14H8V9h7v7zm5 0h-3V9h3v7zm0-9H8V4h12v3z"/>
                    </svg>
                </button>
                <div class="tooltip">
                    ...
                    <span class="tooltiptext">
                        <span class="warning">Important:</span> Click the blue table icon <img src="${svgUri}" alt="Table Icon" style="width: 16px; vertical-align: middle; height: 16px;" />
                         to switch to table view from edit file mode.
